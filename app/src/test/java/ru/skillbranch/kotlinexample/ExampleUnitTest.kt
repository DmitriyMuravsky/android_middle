...
class ExampleUnitTest {
    ...
    @Test
    fun drop_last_until() {
        val test1 = listOf(1, 2, 3).dropLastUntil{ it==2 }
    ...
    fun csv_import() {
        val holder = UserHolder
        val userList = holder.importUsers(listOf(
                " John Doe ;JohnDoe@unknown.com;[B@4ae82894:8c49b8fd5c0c5e2c14bba4459a79b588;;",
                " John Doe ;;[B@4ae82894:8c49b8fd5c0c5e2c14bba4459a79b588;+79112314234;"
        ))
        ...
        val successResult = holder.loginUser(userList[0].login, "testPass")
        Assert.assertEquals(expectedUserInfo1, successResult)
    }
}